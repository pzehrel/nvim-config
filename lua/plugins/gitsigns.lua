...
return {
  ...
  opts = {
    on_attach = function(bufnr)
      ...
      map("n", "<leader>hp", gitsigns.preview_hunk, { desc = "Gitsigns: preview hunk (popup)" })
      ...
      map("n", "<leader>hQ", function() gitsigns.setqflist("all") end, { desc = "Gitsigns: set qflist (all)" })
      map("n", "<leader>hq", gitsigns.setqflist, { desc = "Gitsigns: set qflist" })
